---
name: sc-best-practices
description: Skills derived from the Single-cell Best Practices book (sc-best-practices.org).
...
**Skill file**: [introduction.md](assets/references/introduction.md)
...
**Skill file**: [preprocessing.md](assets/references/preprocessing.md)
...
**Skill file**: [clustering_and_annotation.md](assets/references/clustering_and_annotation.md)
...
**Skill file**: [trajectory_analysis.md](assets/references/trajectory_analysis.md)
...
**Skill file**: [differential_and_condition.md](assets/references/differential_and_condition.md)
...
**Skill file**: [regulatory_and_communication.md](assets/references/regulatory_and_communication.md)
...
**Skill file**: [bulk_deconvolution.md](assets/references/bulk_deconvolution.md)
...
**Skill file**: [chromatin_accessibility.md](assets/references/chromatin_accessibility.md)
...
**Skill file**: [spatial_omics.md](assets/references/spatial_omics.md)
...
**Skill file**: [surface_protein.md](assets/references/surface_protein.md)
...
**Skill file**: [immune_repertoire.md](assets/references/immune_repertoire.md)
...
**Skill file**: [multimodal_integration.md](assets/references/multimodal_integration.md)
...
**Skill file**: [reproducibility.md](assets/references/reproducibility.md)
