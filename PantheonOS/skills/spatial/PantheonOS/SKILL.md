---
name: spatial
description: Skills for spatial transcriptomics analysis including single-cell to
  spatial mapping (MOSCOT), 3D visualization (PyVista), and related spatial workflows.
tags:
- spatial
- mapping
- 3d
...
**Skill file**: [visualize_3d_spatial.md](assets/references/visualize_3d_spatial.md)
...
**Skill file**: [spatial_3d_alignment.md](assets/references/spatial_3d_alignment.md)
...
**Skill file**: [spatial_cci.md](assets/references/spatial_cci.md)
...
**Skill file**: [spatial_deconvolution.md](assets/references/spatial_deconvolution.md)
...
**Skill file**: [spatial_boundary_analysis.md](assets/references/spatial_boundary_analysis.md)
...
**Skill file**: [he_image_registration.md](assets/references/he_image_registration.md)
