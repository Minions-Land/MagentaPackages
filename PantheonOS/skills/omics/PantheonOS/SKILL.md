---
name: omics
description: Skills for single-cell and spatial omics data analysis. Best practices,
  code snippets, and workflows for the scverse ecosystem.
tags: []
source: PantheonOS
...
**Skill index**: [single-cell/SKILL.md](../single-cell/SKILL.md)
...
**Skill folder**: [gene-panel/](./gene-panel/)
...
**Skill index**: [database-access/SKILL.md](../database-access/SKILL.md)
...
**Skill index**: [upstream/SKILL.md](../upstream/SKILL.md)
...
**Skill index**: [data-analysis/SKILL.md](../data-analysis/SKILL.md)
...
**Skill index**: [sc-best-practices/SKILL.md](../sc-best-practices/SKILL.md)
