 ...
 * (omics-preflight.toml) relative to this file and hands it to the host tool runtime at
...
export class HcpMagnet {
	...
	readonly descriptorPath = join(dirname(fileURLToPath(import.meta.url)), "omics-preflight.toml");
