...
export class HcpMagnet {
	static readonly module = "tools/omics-environment";
	...
	readonly descriptorPath = join(dirname(fileURLToPath(import.meta.url)), "omics-environment.toml");
	...
	descriptor() {
		return { kind: "tool" as const, name: "omics-environment", source: "AutOmicScience", descriptorPath: this.descriptorPath };
	}
}
