...
/**
 * Skill Source magnet for the Biomni package (source = "Biomni").
 *
...
export class HcpMagnet {
	static readonly module = "skills/single-cell-annotation";
	static readonly kind = "skill";
	static readonly source = "Biomni";
	static build(_context: unknown) {
		return new HcpMagnet();
	}

	readonly kind = "resource:skill";
	readonly source = "Biomni";
